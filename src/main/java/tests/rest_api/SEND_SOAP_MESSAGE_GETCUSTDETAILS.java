...
@Slf4j
public class SEND_SOAP_MESSAGE_GETCUSTDETAILS extends TestNGCitrusSpringSupport {
    ...
    public void testKafkaUiMessagesHistory() {
        ...
        $(http().client(kafkaUiAuthLocal)
                ...
                .body("{\n" +
                        " \"templateId\" :\"a0000000-0000-0000-0000-000000000020\", \n" +
                        " \"values\": \"{}\"\n" +
                        "}")
                .build());
        ...
        $(http().client(kafkaUiAuthLocal)
                ...
                .message()
                .validate(jsonPath()
                        .expression("$.id", "@ignore()@")
                        .expression("$.requestXml", "@ignore()@")
                        .expression("$.responseXml", "@ignore()@")
                        .expression("$.status", "success")
                        .expression("$.createdAt", "@ignore()@")
